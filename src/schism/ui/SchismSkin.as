package schism.ui 
{
	...
	public class SchismSkin extends PunkSkin 
	{
		...
		public function SchismSkin()
		{
			...
			punkButton = new PunkSkinButtonElement(gy(0, 0, 32, 32), gy(32, 0, 32, 32), gy(64, 0, 32, 32), gy(0, 0, 32, 32), { color: 0xFFFFFF, size: 18, outlineColor: 0x000000, outlineStrength: 2, font: "Domo" } );
			punkLabel = new PunkSkinHasLabelElement( { color: textColor, size: 16, font: "Domo" } );
			punkTextField = new PunkSkinLabelElement( { color: 0x000000, size: 16, font: "Domo" }, gy(0, 32, 32, 32));
